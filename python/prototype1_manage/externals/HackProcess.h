		...
		while (__RunModule)
		{
			if (!strcmp(lpModuleEntry.szModule, LPSTRModuleName))
			{
				...
				return (DWORD)lpModuleEntry.modBaseAddr;
						   //                unsigned long retVal = *reinterpret_cast<unsigned long long *>(lpModuleEntry.modBaseAddr);
			}
