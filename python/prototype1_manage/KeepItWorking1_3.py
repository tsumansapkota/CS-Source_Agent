        ...
        while not self.stop_thread:
            ...
            try:
                ...
                for num in range(givenBox):
                    ...
                    #     values[2] += values[0]
                    #     values[0] = 0
                    # elif values[0] + values[2] > width:
                    #     values[2] = width - values[0]
                    # if values[1] < 0:
                    #     values[3] += values[1]
                    #     values[1] = 0
                    # elif values[1] + values[3] > height:
                    #     values[3] = height - values[1]

                    # when the proportion of the image is very poor
                    # if values[2] / values[3] < 0.1 or values[3] / values[2] < 0.25:
                    #     continue

                    box = BoxPlayer(values[0], values[1], values[3]//2, values[3], values[4])
